...
A single bearer-token-authenticated MCP endpoint (`Streamable HTTP`, port `8462`, bound to the Tailscale IP) serving **21 tools** across five families:
...
| 5 | System tools | 🟢 deployed live (21 tools); laptop sign-off pending |
| 5.5 | Location-primitive prelude (fresh-fix GPS, accuracy gate, distance) | 🟢 deployed |
| 6 | Voice AI + offline autonomy queue | ⬜ planned |
